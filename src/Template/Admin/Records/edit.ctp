...
<div class="row no-gutters">
  <div class="col-11 mx-auto">
    <div class="card">
      ...
      echo $this->Form->input('from', ['options' => $stations, 'class' => 'form-control']);
      echo $this->Form->input('line_id', ['options' => $lines, 'class' => 'form-control']);
      echo $this->Form->input('to', ['options' => $stations, 'class' => 'form-control']);
      echo $this->Form->input('stops', ['class' => 'form-control']);
      echo $this->Form->input('ticket_inspector', ['class' => 'form-control']);
      ?>
